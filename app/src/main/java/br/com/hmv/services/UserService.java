...
import br.com.hmv.dtos.request.UserUpdateRequestDTO;
import br.com.hmv.dtos.responses.UserDefaultResponseDTO;
import br.com.hmv.dtos.responses.UserExtendsResponseDTO;
...
public class UserService implements UserDetailsService {
	...
	private void copyDtoToEntity(UserDTO dto, User entity) {
		...
		if(dto instanceof UserUpdateRequestDTO){
			...
			//encode/criptografia de senha do usuário
